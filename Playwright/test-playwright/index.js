  ...
  for (const browserType of ['chromium']){//, 'firefox', 'webkit']) {
    ...
    for(var i=0; i < signup.length; i++){
        try{
            ...
            await page.waitForLoadState();
            await page.screenshot({path: `./screenshots/feature1/s${i+1}/1.png`})
            ...
            await page.screenshot({path: `./screenshots/feature1/s${i+1}/2.png`})
    
            console.log("      And I try to login")
            await page.click('button[type="submit"]')
            
            console.log(`      Then I expect to see ${signup[i].error}`)
            await page.screenshot({path: `./screenshots/feature1/s${i+1}/3.png`})
    ...
    try{
        ...
        await page.click('text=reate your account →');
        await page.waitForLoadState();
        await page.screenshot({path: `./screenshots/feature1/s${signup.length + 1}/1.png`})
        ...
        await page.screenshot({path: `./screenshots/feature1/s${signup.length + 1}/2.png`})
        ...
        await page.screenshot({path: `./screenshots/feature1/s${signup.length + 1}/3.png`})
        if( await page.url() === url+"ghost/#/dashboard"){console.log("\n  --Scenario succesfully tested--\n\n")}else{console.log(`\n  --Feature 1 - scenario ${signup.length + 1} failed: No fue dirigido al dashboard \n\n`)}
    ...
    for(var i=0; i < members.length; i++){
        ...
        try{
            ...
            await page.screenshot({path: `./screenshots/feature2/s${i+1}/1.png`})
        

            console.log(`      When I click "New member" `)
            await page.click("text=New member");
            await page.waitForLoadState();
            await page.screenshot({path: `./screenshots/feature2/s${i+1}/2.png`})
            ...
            await page.screenshot({path: `./screenshots/feature2/s${i + 1}/3.png`})
            ...
            await page.screenshot({path: `./screenshots/feature2/s${i + 1}/4.png`})
    ...
    try{
        ...
        await page.goto(url + 'ghost/#/members');
        await new Promise(r => setTimeout(r, 3000));
        await page.screenshot({path: `./screenshots/feature2/s${members.length+1}/1.png`})
    

        console.log(`      When I click "New member" `)
        await page.click("text=New member");
        await page.waitForLoadState();
        await page.screenshot({path: `./screenshots/feature2/s${members.length+1}/2.png`})
        ...
        await page.screenshot({path: `./screenshots/feature2/s${members.length + 1}/3.png`})
    ...
    try{
        ...
        await page.goto(url + 'ghost/#/members');
        await new Promise(r => setTimeout(r, 3000));
        await page.screenshot({path: `./screenshots/feature2/s${members.length + 2}/1.png`})
    

        console.log(`      When I click "New member" `)
        await page.click("text=New member");
        await page.waitForLoadState();
        await page.screenshot({path: `./screenshots/feature2/s${members.length + 2}/2.png`})

        console.log(`      And I fill with 'A', 'A', 'a@a.com', 'Notas' and 'false'`)
        await page.fill('input[name="name"]', "A")
        await page.fill('input[name="email"]', 'a@a.com')
        await page.fill('textarea[name="note"]', 'Notas')
        await page.screenshot({path: `./screenshots/feature2/s${members.length + 2}/3.png`})
        ...
        await page.screenshot({path: `./screenshots/feature2/s${i + 2}/4.png`})
    ...
    for(var i=0; i < tags.length; i++){
        ...
        try{
            ...
            await page.goto(url + 'ghost/#/tags');
            await new Promise(r => setTimeout(r, 5000));
            await page.screenshot({path: `./screenshots/feature3/s${i+1}/1.png`})
        

            console.log(`      When I click "New Tag" `)
            await page.click("text=New tag");
            await page.waitForLoadState();
            await page.screenshot({path: `./screenshots/feature3/s${i+1}/2.png`})
            ...
            await page.screenshot({path: `./screenshots/feature3/s${i + 1}/3.png`})
            ...
            await page.screenshot({path: `./screenshots/feature3/s${i + 1}/4.png`})
    ...
    try{
        ...
        await page.goto(url + 'ghost/#/tags');
        await new Promise(r => setTimeout(r, 3000));
        await page.screenshot({path: `./screenshots/feature3/s${tags.length + 1}/1.png`})
    

        console.log(`      When I click "New Tag" `)
        await page.click("text=New tag");
        await page.waitForLoadState();
        await page.screenshot({path: `./screenshots/feature3/s${tags.length+1}/2.png`})
        ...
        await page.screenshot({path: `./screenshots/feature3/s${tags.length + 1}/3.png`})
        ...
        await page.screenshot({path: `./screenshots/feature3/s${tags.length + 1}/4.png`})
    ...
    for(var i=0; i < staff.length; i++){
        ...
        try{
            ...
            await page.screenshot({path: `./screenshots/feature4/s${i+1}/1.png`})
        

            console.log(`      When I click "Invite people" `)
            await page.click("text='Invite people'", {force: true});
            await page.waitForLoadState();
            await page.screenshot({path: `./screenshots/feature4/s${i+1}/2.png`})
            ...
            await page.screenshot({path: `./screenshots/feature4/s${i + 1}/3.png`})
            ...
            await page.screenshot({path: `./screenshots/feature4/s${i + 1}/4.png`})
    ...
    try{
        ...
        await page.goto(url + 'ghost/#/staff');
        await new Promise(r => setTimeout(r, 3000));
        await page.screenshot({path: `./screenshots/feature4/s${staff.length + 1}/1.png`})
    

        console.log(`      When I click "invite people" `)
        await page.click("text=Invite people");
        await page.waitForLoadState();
        await page.screenshot({path: `./screenshots/feature4/s${staff.length + 1}/2.png`})
        ...
        await page.screenshot({path: `./screenshots/feature4/s${staff.length + 1}/3.png`})
        ...
        await page.screenshot({path: `./screenshots/feature4/s${staff.length + 1}/4.png`})
    ...
    try{
        ...
        await new Promise(r => setTimeout(r, 3000));
        await page.screenshot({path: `./screenshots/feature5/s1/1.png`})
    

        console.log(`      When I click Theme`)
        await page.click("text=Theme");
        await new Promise(r => setTimeout(r, 3000));
        await page.screenshot({path: `./screenshots/feature5/s1/2.png`})

        console.log(`      And I click Install`)
        await page.click("text=Install", {force: true});
        await new Promise(r => setTimeout(r, 3000));
        await page.screenshot({path: `./screenshots/feature5/s1/3.png`})

        console.log(`      And I click Install`)
        await page.click('.gh-btn-icon', {force: true});
        await new Promise(r => setTimeout(r, 10000));
        await page.screenshot({path: `./screenshots/feature5/s1/4.png`})

        console.log(`      Then I expect to see a new theme in Installed themes`)
        await page.goto(url + 'ghost/#/settings/theme');
        await new Promise(r => setTimeout(r, 3000));
        await page.screenshot({path: `./screenshots/feature5/s1/5.png`})       
    ...
    try{
        ...
        await page.goto(url + 'ghost/#/settings');
        await new Promise(r => setTimeout(r, 3000));
        await page.screenshot({path: `./screenshots/feature5/s2/1.png`})
    

        console.log(`      When I click Activate`)
        await page.click("text=ACTIVATE");
        await new Promise(r => setTimeout(r, 3000));
        await page.screenshot({path: `./screenshots/feature5/s2/2.png`})

        console.log(`      Then I expect to see the new theme activated`)
        await page.goto(url + 'ghost/#/settings');
        await new Promise(r => setTimeout(r, 3000));
        await page.screenshot({path: `./screenshots/feature5/s2/3.png`})  
